...
class _HtmlState extends State<Html> {
  ...
  late Map<String, Style> style;
  late List<HtmlExtension> extensions = <HtmlExtension>[
    TagExtension(tagsToExtend: {'br'}, child: const SizedBox())
  ];

  @override
  void initState() {
    super.initState();
    style = Map<String, Style>.from(widget.style);
    extensions.insertAll(0, widget.extensions);
